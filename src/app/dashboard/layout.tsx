...
export default function DashboardLayout({
    ...
    const isProjectPage = pathname.split('/').length > 2 && pathname !== '/dashboard/integrations' && pathname !== '/dashboard/settings';
                    ...
                    <div className="p-4 border-t border-zinc-200 dark:border-zinc-800 mt-auto">
                        <button className="flex items-center gap-3 w-full p-2 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors text-left group">
                            <div className="size-8 rounded bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 flex items-center justify-center shrink-0">
                                <span className="text-[10px] font-bold text-zinc-500 dark:text-zinc-400">AR</span>
                            </div>
                            <div className="flex-1 min-w-0">
                                <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100 truncate" style={{ fontFamily: 'var(--font-shippori)' }}>Alex Rivera</p>
                                <p className="text-[10px] text-zinc-400 dark:text-zinc-500 truncate lowercase tracking-tight">alex@dambo.ai</p>
                            </div>
                        </button>
                    </div>
                </aside>
